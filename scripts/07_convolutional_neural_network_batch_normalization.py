...
print "Max test accuracy achieved = {:.2f}%".format(max(test_accuracies) * 100) # 99.22%
...
plt.savefig("output_images/07_convolutional_neural_network_batch_normalization.png")
